...
echo ""
echo "⚠️  Manual steps (3 quick ones — do these now):"
echo ""
echo "   STEP 1 — Log out and back in once:"
echo "   Apple menu → Log Out → Log back in"
echo "   (activates Ctrl+1–10 keyboard shortcuts)"
echo ""
echo "   STEP 2 — Grant Accessibility permission (required — restore silently"
echo "   fails without this):"
echo "   System Settings → Privacy & Security → Accessibility → click '+'"
echo "   → press Cmd+Shift+G → type /usr/bin/osascript → Add → toggle it ON"
echo ""
echo "   STEP 3 — Pin single-window apps to their desktop:"
